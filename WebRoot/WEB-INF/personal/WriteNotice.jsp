		...
		<div class="content_resize" style="height: ;">
			...
			<script type="text/javascript"
				...
				<div style="border: 1px black solid;height: auto; ">
				  ...
				  <s:form action="addNotice"   method="post" onsubmit="return validate()">
				
				              公告题目 :&nbsp;<s:textfield style="border:1px black solid;"  name="notice.title" id="title"></s:textfield>
				      <br>
				      <br>
				      <s:textarea name="notice.body" id="body" style="border:1px solid black;height:580px;width:680px;">

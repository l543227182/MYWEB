			...
			<div style="border: 1px black solid;height: 500px;">
				<div class="content_left">
					<ul>
						...
						<li><a
							href="${pageContext.request.contextPath}/changeFile_execute.do">修改文件</a></li>
					</ul>
				</div>
				<hr width="68%" style="margin-top: 50px;">
				<div class="content_right" style="">
					<div>
						<s:form action="changeFile_updateFile" method="post">
							<input type="hidden" name="fileId" value="${file.id}">
							<table border="2" style="border: 1px black solid; " width="300px" height="200px">
								<tr>
									<td>文件名字：</td>
									<td><s:textfield name="fileName" cssClass="InputStyle" style="border:1px black solid;"></s:textfield></td>
								</tr>
								<tr>
									<td>文件公开：</td>
									<td><s:radio list="#{'1':'是','2':'否'}" name="state"></s:radio></td>
								</tr>
								<tr>
								<td style="margin-left: 1px; ">文件转让給 ：</td>
								<td><s:textfield name="ToUser" style="border:1px black solid;"></s:textfield></td>
							</tr>
							<tr>
							<th><s:submit value="修改" /></th>
						  </tr>
							</table>
						</s:form>
					</div>

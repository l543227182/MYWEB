	...
	<div class="main">
		...
		<div class="content_resize" style="height: ;">
			...
			<script type="text/javascript"
				...
				<div style="border: 1px black solid;height: 300px; margin-top: 12px;">
	    <br>
				  <s:form action="changeData_execute" method="post"
							onsubmit="return dosubmit()" id="register">
							<s:token></s:token>
							<b style="color: black;">姓名</b>
							<s:textfield name="username" label="user.name" style="border:1px black solid;"></s:textfield>
							<br>
							
							<br>

							<b style="color: black;">年龄</b>
							<s:textfield name="userage"  style="border:1px black solid;"  label="user.age"></s:textfield>
							<br>
							<br>

							<b style="color: black;margin-right:76px;">性别</b>&nbsp;<s:radio
								list="#{'1':'男','2':'女'}" name="usergender"></s:radio>
							<br>
							
							<br>

							
							<b style="color: black;">旧密码</b>
							<s:password  style="border:1px black solid;" name="oldpassword" label="user.password"></s:password>
							<br>
							<s:fielderror fieldName="oldPassword"></s:fielderror>
							<br>
                            <b style="color: black;">新密码</b>
							<s:password  style="border:1px black solid;" name="newPassword" label="user.password"></s:password>
							<br>
                      
							<br>
							<b style="color: black;">重复密码</b>
							<s:password  style="border:1px black solid;" name="reNewPassword" label="user.password"></s:password>
							<br>
						
							<br>
						
							<b style="color: black;margin-left: 35px">生日</b>
							<select id="year"><option value="1900"></option></select>年
    			            <select id="month"><option value="01"></option></select>月
    			            <select id="day"><option value="01"></option></select>日
                            <br>
							<br>
							<b style="color: black;">电话</b>
							<s:textfield  style="border:1px black solid;" name="userCellphone" label="user.cellphone"></s:textfield>
							<br>
							<s:fielderror fieldName="userCellphone"></s:fielderror>
							<br>
							<s:submit value="修改">
							</s:submit>

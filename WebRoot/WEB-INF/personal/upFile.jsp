	...
	<div class="main">
		<div class="header" style="height: 100px">
			<div class="header_resize"
				style="height:100px;border: 1px #959595 solid;">
				<div class="logo">
					<h1>
		...
		<div class="content_resize" style="height: ;">
			...
			<div class="layoutA" style="margin-top:5px;height: 178px;">
				...
				<div class="mainBox clear"
					style="height: 178px;width:500px;float:right ;">

					<div class="right"
						style="float:right;margin-bottom: 50px;margin-left: 100px;">
			...
			<div style="clear: both;"></div>
			<div style="border: 1px #959595 solid;height: 500px;">
				<div class="content_left">
					<ul>
						<li><a
							href="${pageContext.request.contextPath}/fileCenter.do">我的文件</a></li>
				...
				<div class="content_right">
					<div style="margin-top: 50px">
						<s:form action="fileup" method="post"
							enctype="multipart/form-data">

							<table style="border: 1px #959595 solid; ">
								<tr>
									<td style="float: left;">文件名：</td>
									<td><s:textfield name="filename" style="border:1px #959595 solid;"></s:textfield></td>
								</tr>
								<tr><td></td></tr>
								<tr><td></td></tr>
								<tr><td></td></tr>
								<tr>
									<td style="float: left;">文件： </td>
									<td ><s:file name="photo"></s:file></td>
								</tr>
								<tr><td> </td></tr>
								<tr><td></td></tr>
								<tr><td></td></tr>
									...
									<td>公开：</td>
									<td>
									  <s:radio list="#{'1':'是','2':'否'}" name="state"></s:radio>
									 </td>
									</tr>								
									<tr>
									<td>备注：</td>
									<td><s:textarea style="border:1px #959595 solid" rows="10" cols="30" name="beizhu"></s:textarea></td>
									</tr>
								
								<tr>
									<td><s:submit value="提交" style="border:1px #959595 solid;"/></td>
								</tr>
							</table>
						</s:form>
					</div>

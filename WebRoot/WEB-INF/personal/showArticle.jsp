...
<body style="text-align: center; background-color: gray;">
	...
	<div class="main" >
		...
		<div class="content_resize" style="background-color: #fff;">
			<div style="clear: both;"></div>
			<div class="menu_nav"
			...
			<script type="text/javascript"
				...
				<br>
				<b style="text-align: center;font-size: 32px;">${article.title}</b><br><br>
				  <div style="text-align: left;width: 200px;"><div style="margin-left: 65px;">——By&nbsp;&nbsp;${article.username},
				                                              &nbsp;${article.time}
				                                              </div>
				  </div> 			
				 ...
				 <b style="font-size: 8px;"><a href="${pageContext.request.contextPath}/updateArticle.do?article=${article.id}">>>修改文章<<</a></b>
				</div>
				<div  style="clear: both;"></div>				
		</div>
		<div  style="clear: both;"></div>

		...
		<div class="content_resize" style="height: ;">
			...
			<div class="menu_nav"
				...
				<ul id="spaceUL" style="float: left;margin-top: 1px;">
					...
					<li><a href="${pageContext.request.contextPath}/changeData.do">资料修改</a></li>
				</ul>
			</div>
			...
			<script type="text/javascript"
				...
				<br>
				  <b style="font-size: 12px;"><a href="#">写个公告吧</a></b>
				  <br>
				  <br>
				  <img  src="${pageContext.request.contextPath}/image/12.gif">
				</c:if>
				<c:if test="${page.list!=null}">
				<br>
				  <b style="font-size:14px">公告管理</b>
				  <br>
				  <br>
				  <table width="520px">
				     <tr>
				     ...
				     <c:forEach varStatus="status" var="notice" items="${page.list}">
				      <tr>
				      ...
				      <td>${notice.time}</td>
				      <td>
				       <a href="${pageContext.request.contextPath}\deleteNotice.do?noticeId=${notice.id}">删除</a>
				       <a href="${pageContext.request.contextPath}\LookUpNotice.do?noticeId=${notice.id}">查看</a>
				      </td>
				     </tr>	
				     </c:forEach>			     
				  </table>
				...
				<br>
				<a href="${pageContext.request.contextPath}/WriteNotice.do"><b style="font-size:15px;">————————————————发布公告————————————————</b></a>
				</div>
				<div  style="clear: both;"></div>
			...
			<div class="footer_resize">
				...
				<div class="menu_nav" style="width:530px; ">
					...
					<ul>
						...
						<li><a href="${pageContext.request.contextPath}/personalSpace.do">个人中心</a></li>
